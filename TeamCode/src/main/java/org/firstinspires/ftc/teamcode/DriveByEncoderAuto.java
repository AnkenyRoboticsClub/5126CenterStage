...
@Autonomous(name="Robot: Auto OutlineTest", group="Robot")
//@Disabled
public class DriveByEncoderAuto extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
            //moveDistance(0.5, 12);
            if(gamepad1.a){
                telemetry.addData("rotation", imu.getRobotOrientation(AxesReference.INTRINSIC, AxesOrder.ZXY, AngleUnit.DEGREES));
                turn(90);
            }
            telemetry.update();
            //claw.setPower(0);
    ...
    public void moveDistance(double power, int distance){
        ...
        backRight.setTargetPosition((distance * (int) COUNTS_PER_INCH) / 2);
        ...
        telemetry.addData("Motor position backRight:", backRight.getCurrentPosition());
        telemetry.addData("Motor power backRight:", backRight.getPower());
        telemetry.addData("Motor position backLeft:", backLeft.getCurrentPosition());
